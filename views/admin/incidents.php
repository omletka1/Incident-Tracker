...
<div class="interface-container">
    <div class="page-header">
        <div class="page-title-section">
            <h1 class="page-title">Все инциденты</h1>
    ...
    <div class="filter-card">
        ...
        <div class="filter-actions">
            ...
            <?= Html::a('
                ...
                Сбросить фильтры
            ', ['admin/incidents'], ['class' => 'btn btn-secondary']) ?>
        </div>
        <?php ActiveForm::end(); ?>
    </div>
        ...
        <div class="table-responsive">
            <?= GridView::widget([
                ...
                <div class="empty-state">
                    ...
                    <div class="empty-state-title">Инцидентов не найдено</div>
                    ...
                    [
                        ...
                        'buttons' => [
                            'view' => function($url, $model) {
                                ...
                                Просмотр
                            ', ['incident/view', 'id' => $model->id], ['class' => 'action-link action-view']);
                            },
                            'update' => function($url, $model) {
                                ...
                                Редактировать
                            ', ['edit-incident', 'id' => $model->id], ['class' => 'action-link action-update']);
                            },
                        ]
                    ],
                ],
