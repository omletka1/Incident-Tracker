...
<div class="interface-container">
    <div class="page-header">
        <div class="page-title-section">
            <h1 class="page-title">
                <?= $model->isNewRecord ? 'Создание инцидента' : 'Редактирование инцидента' ?>
            </h1>
            <p class="page-subtitle">
                <?= $model->isNewRecord
                    ? 'Заполните форму ниже для создания нового инцидента'
                    : 'Обновите информацию об инциденте'
                ?>
            </p>
        </div>
        ...
        <div class="form-group fade-in-up">
            ...
            <div class="select-wrapper">
                <?= $form->field($model, 'priority', [
                    ...
                    ['class' => 'form-control', 'prompt' => 'Выберите приоритет...']
                )->label(false) ?>
            </div>
        </div>
